...
namespace Raven.Models
{
    public class Visite
    {
        ...
        public string TypeVisite { get; set; } = "Pr̩ventive"; // Pr̩ventive, Curative, Audit, Diagnostic, Autre
        ...
        public string Statut { get; set; } = "Planifi̩e"; // Planifi̩e, En cours, Valid̩e, En retard, Annul̩e
